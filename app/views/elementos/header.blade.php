		...
		?>
				...
				<header id="header">
					<div id="logo-group">
						...
						<span style="pading-top:10px; display:inline-block;"> 
							<h1><!--
								@if (Session::has('sucursal')) 
									{{  $value=Session::get('sucursal', 'default') }}
									{{  Session::put('sucursal', $value); }}
								@else 
									noo 
								@endif -->
								...
								@elseif((Auth::user()->id_role)==3)
									Contabilidad
								@else
									{{ $sucursal=Session::get('suc','NO hay nada') }}
								@endif	
							</h1>
...
-->
					...
					<div class="pull-right">
						...
						<ul id="mobile-profile-img" class="header-dropdown-list hidden-xs padding-5">
							<li class="">
								...
								<ul class="dropdown-menu pull-right">
									...
									<li class="divider"></li>
									<li>
										<a href="login" class="padding-10 padding-top-5 padding-bottom-5" data-action="userLogout"><i class="fa fa-sign-out fa-lg"></i> <strong><u>C</u>errar sesión</strong></a>
									</li>
								</ul>
							</li>
						</ul>
						...
						<div id="logout" class="btn-header transparent pull-right">
							<span> <a href="logout" title="Salir" data-action="userLogout" data-logout-msg="Para mayor seguridad debe cerrar sesión antes de cerrar el navegador"><i class="fa fa-sign-out"></i></a> </span>
						</div>
						<!-- end logout button -->
