				...
				<div>
					...
					<div class="widget-body">
						...
						<form class="form-horizontal" method="post" action="ingresos/guarda" nombre="formulario" onsubmit="return  CalculaDepositos(1,'form')">
						  <input type="hidden" value="{{ Session::get('short_sucu') }}" name="sucursal" id="sucursal">
						...
						<!--Calendario Fecha-->
							...
							<div class="col-md-10">
									<div class="col-sm-12 col-md-4 col-lg-2">
										<div class="form-group">											
											<input class="form-control spinner-both"  name="num_deposito" style="text-align:center !important;"  id="spinner-currency" min="0" name="spinner-currency" value="1" readonly>
										</div>
									</div>
							</div>
							</div>
		...
		for (var i=1; i<=maximo ; i++) {
			...
			if (tipo_cantidad=="form"){
				...
				if (total==0) {
					...
					alert("TUS DEPÓSITOS NO COINCIDEN CON LA VENTA DEL DÍA");
					return false;					
				}
			}
