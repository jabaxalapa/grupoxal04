...
$qu2="SELECT cobCajeEfectivo, fechaRep FROM kfc_boulevard WHERE fechaRep>'$nuevafecha' ORDER BY fechaRep DESC ";
		...
		function generatePageGraphs() {
		   ...
		   // $(function () {
		    ...
		    $(function () {
		        ...
		        var plot3 = $.plot($("#statsChartDQ"), data, options);
		    });
		    // END TAB 2
